(function () {
  ...
  const STORAGE_KEYS = {
    ...
    routeStartTime: "tdsRouteStartTime",
    showRouteTimes: "tdsShowRouteTimes"
  };
  ...
  const WAIT_IMPORT_PENDING_KEY = "tdsWaitImportPending";
  const WAIT_IMPORT_CONFIG = window.TDR_WAIT_IMPORT_CONFIG || { parkId: "", disneyRealUrl: "", entries: [] };
  const ATTRACTION_DURATIONS = window.TDS_ATTRACTION_DURATIONS || {};
  ...
  const AREA_TRAVEL_MINUTES = {
    ...
    AW: { MH: 8, AW: 6, PD: 8, FS: 25, LR: 22, AC: 25, ML: 20, MI: 15 },
    ...
    AC: { MH: 18, AW: 25, PD: 20, FS: 8, LR: 8, AC: 6, ML: 8, MI: 12 },
